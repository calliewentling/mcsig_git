...
class QueryGazetteer {
   ...
   public function getResults($params) {
       ...
       $_result =  pg_query($db, "SELECT place_name AS placeName, place_desc AS placeDesc, geom, place_id AS placeId FROM public.user_gazetteer") or die('Connection Error: ' . $_db->connect_error);
