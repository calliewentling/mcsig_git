...
function setColors() {
    //Ultimately we should call the 
    if (pub.toLowerCase() == "a mensagem") {
        var pubColor = "#5AA0D5";
    } else if (pub.toLowerCase() == "campo de ourique notícias") {
        var pubColor = "#DC0C15";
    } else if (pub.toLowerCase() == "jfc facebook"){
        var pubColor = "#437943";
    } else if (pub.toLowerCase() == "cml notícias"){
        pubColor = "#000000";
    } else {
        pubColor = "#ffff00";
    }
