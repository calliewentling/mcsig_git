...
def pub_map(publication):
    ...
    try:
        ...
        for row in result:
            ...
            return render_template("jornal/jornal_map.html", publication = publication ,e_id=e_id, jVals = jVals)
    return render_template("explore/explore_map.html")
